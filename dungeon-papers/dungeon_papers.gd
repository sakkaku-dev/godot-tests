...
func setup_round(current_round: int):
	...
	if current_round == 0:
		available_builds = [DungeonGame.Build.SKELETON_WARRIOR]
	elif current_round == 1:
		available_builds = [DungeonGame.Build.SKELETON_WARRIOR, DungeonGame.Builds.GOBLIN_WARRIOR]
	elif current_round >= 2:
		available_builds = [DungeonGame.Build.SKELETON_WARRIOR, DungeonGame.Builds.GOBLIN_WARRIOR, DungeonGame.Builds.SKELETON_ARCHER]
